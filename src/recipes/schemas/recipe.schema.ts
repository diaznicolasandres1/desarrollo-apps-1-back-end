...
export class Recipe extends Document {
  ...
  @ApiProperty({
    ...
    example: [
      { id: '1', title: 'Preparación de la masa', description: 'Mezclar los ingredientes secos', mediaResource: 'https://example.com/step1.jpg' },
      { id: '2', title: 'Horneado', description: 'Hornear a 180°C por 45 minutos' }
    ]
  })
  @Prop({ required: true })
  steps: Step[];
  ...
  @ApiProperty({
    ...
    example: [
      { url: 'https://example.com/main.jpg', description: 'Tarta de manzana terminada' }
    ]
  })
