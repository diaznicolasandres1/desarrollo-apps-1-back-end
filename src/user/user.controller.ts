...
export class UserController {
  ...
  @ApiResponse({
    status: 400,
    description: "El registro del usuario no está completo",
  })
  ...
  @ApiResponse({
    status: 400,
    description: "El usuario no está completamente registrado",
  })
  ...
  @ApiOperation({
    ...
    description:
      "Agrega una receta a la lista de favoritos del usuario. La receta no debe estar ya en la lista de favoritos.",
  })
  @ApiParam({
    name: "id",
  ...
  @ApiResponse({
    ...
    schema: {
      ...
      properties: {
        ...
        message: {
          type: "string",
          example: "Receta agregada a favoritos exitosamente",
        },
        data: {
          type: "object",
          description: "Usuario actualizado con la nueva receta en favoritos",
        },
      },
    },
  })
  @ApiResponse({
    ...
    schema: {
      ...
      properties: {
        ...
        message: {
          type: "string",
          example: "Usuario con ID 507f1f77bcf86cd799439011 no encontrado",
        },
  ...
  @Delete(":id/favorite-recipe/:recipeId")
  @ApiOperation({
  ...
  @ApiParam({
    name: "id",
    description: "ID del usuario al que se le eliminará la receta de favoritos",
    example: "507f1f77bcf86cd799439011",
  })
  @ApiParam({
    name: "recipeId",
    description: "ID de la receta a eliminar de favoritos",
    example: "receta123",
  })
  @ApiResponse({
    status: 200,
    ...
    schema: {
      ...
      properties: {
        ...
        message: {
          type: "string",
          example: "Receta eliminada de favoritos exitosamente",
        },
        data: {
          type: "object",
          description: "Usuario actualizado sin la receta en favoritos",
        },
      },
    },
  })
  @ApiResponse({
    ...
    schema: {
      ...
      properties: {
        statusCode: { type: "number", example: 404 },
        message: { type: "string", example: "Usuario o receta no encontrados" },
        error: { type: "string", example: "Not Found" },
      },
    },
  })
  async removeFavoriteRecipe(
    ...
    const user = await this.userService.removeFavoriteRecipe(id, recipeId);
    return {
      statusCode: HttpStatus.OK,
